        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
            ...
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              ...
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl flex flex-col md:block items-center">
                <span className="block xl:inline flex items-center justify-center md:justify-start gap-5">
                    <img src={logo} alt="Logo" className="inline-block h-15 w-20 md:h-28 md:w-18 object-contain -mt-3" />
                    Smart Healthcare
                </span>
